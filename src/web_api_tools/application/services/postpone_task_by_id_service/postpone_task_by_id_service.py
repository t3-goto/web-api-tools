...
from .dto.postpone_task_by_id_service_in_dto import ServiceInDto  # InDtoのインポート
from .dto.postpone_task_by_id_service_out_dto import (  # OutDtoのインポート
    ServiceOutDto,
)


class PostponeTaskByIdApplicationService:
