...
from .dto.rename_task_by_id_service_in_dto import ServiceInDto  # InDtoのインポート
from .dto.rename_task_by_id_service_out_dto import (  # OutDtoのインポート
    ServiceOutDto,
)


class RenameTaskByIdApplicationService:
    ...
    async def execute(self, service_in_dto: ServiceInDto):
        ...
        task.rename(service_in_dto.name)
