...
from ....application.services.rename_task_by_id_service import ServiceInDto
from ...dependencies import (
    get_rename_task_by_id_application_service as get_service,
)
from .schemas import rename_task_by_id_request_schema as request_schema
from .schemas import rename_task_by_id_response_schema as response_schema

router = APIRouter()


@router.put(
    "/api/v1/tasks/{id}/rename",
...
async def execute(
    ...
    service_in_dto = ServiceInDto(id=path_params.id, name=request_body.name)
